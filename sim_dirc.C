{
  ...
  fRun->SetGenerator(primGen);
   ...
   // Box Generator
  FairBoxGenerator* boxGen = new FairBoxGenerator(11, 1); // 321 = kaon; 1 = multipl. 11=electron
  boxGen->SetPRange(0.855.,0.855.); // GeV/c
  boxGen->SetPhiRange(0.01, 0.01); // Azimuth angle range [degree]
  boxGen->SetThetaRange(110., 110.); // Polar angle in lab system range [degree]
  boxGen->SetXYZ(-40., 100., 0.); // mm o cm ??
